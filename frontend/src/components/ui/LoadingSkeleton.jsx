...
const sweep =
  'rounded-md bg-[linear-gradient(90deg,#1C2638_25%,#243044_37%,#1C2638_63%)] bg-[length:400%_100%] animate-skeleton-sweep';
...
export function ResultsSkeleton({ rows = 4 }) {
  return (
    <div className="space-y-5" aria-label="Loading results" role="status">
