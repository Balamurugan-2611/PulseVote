  ...
  return (
    <div className="relative">
      <select
        ...
        className="h-11 w-full appearance-none rounded-lg border border-line-strong bg-raised pl-3.5 pr-10 text-sm font-medium text-ink transition-[border-color,box-shadow] duration-150 ease-swift hover:border-brand-500/50 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/20 sm:w-[150px]"
      >
        {options.map((option) => (
